...
$$
    ...
    try {
        ...
        snowflake.execute({sqlText: `GRANT USAGE ON DATABASE ${DESTINATION_DB_NAME} TO AWS_LAMBDA_BASE_API`});
        ...
        snowflake.execute({sqlText: `GRANT OWNERSHIP ON FUTURE SCHEMAS IN DATABASE ${DESTINATION_DB_NAME} TO ROLE ${ROLE_NAME};`});
        ...
        snowflake.execute({sqlText: `GRANT USAGE ON ALL STAGES IN DATABASE ${DESTINATION_DB_NAME} TO ROLE AWS_LAMBDA_BASE_API;`});
